...
public class AcBus extends Bus 
{
	...
	public AcBus(String busType,String busNo, String boarding, String dropping , String date , String departureTime, double ticketPrice, int ticketNo, int ticketAvailableQuantity)
	{
	...
	{
		System.out.println("===========================");
		System.out.println("******AC BUS SERVICE*******");
		System.out.println("===========================");
